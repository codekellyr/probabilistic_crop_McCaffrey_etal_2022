...
area*0.000247105 #68.9423
#buffer again
rbuff<-buffer(rbuff, width=30, doEdge=T) #buffer by 30 m - one pixel layer
rbuff<-mask(rbuff, cultivated, inverse=T, maskvalue=1, updateValue=NA)
marea<-rbuff*900
area<-cellStats(marea, sum, na.rm=T)
area*0.000247105 #157.2329
#buffer again
rbuff<-buffer(rbuff, width=30, doEdge=T) #buffer by 30 m - one pixel layer
rbuff<-mask(rbuff, cultivated, inverse=T, maskvalue=1, updateValue=NA)
marea<-rbuff*900
area<-cellStats(marea, sum, na.rm=T)
area*0.000247105 #276.6588
#buffer again
rbuff<-buffer(rbuff, width=30, doEdge=T) #buffer by 30 m - one pixel layer
rbuff<-mask(rbuff, cultivated, inverse=T, maskvalue=1, updateValue=NA)
marea<-rbuff*900
area<-cellStats(marea, sum, na.rm=T)
area*0.000247105 #421.8824
